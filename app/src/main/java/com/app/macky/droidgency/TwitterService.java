...
public class TwitterService {
    ...
    private static final String ACCESS_TOKEN = "wLQyFG9FkR2ouMVpli1fJPiuP";
    private static final String ACCESS_TOKEN_SECRET = "cBLKQMAf39RukMz5YHIoOqJTcy333P0musyDwZgDD58YwRQG2n";
